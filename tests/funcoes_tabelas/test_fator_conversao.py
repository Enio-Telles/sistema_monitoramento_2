...
def test_ler_fatores_manuais_success(tmp_path, monkeypatch):
    ...
    # Create valid polars dataframe with columns matching what ler_fatores_manuais expects
    ...
    assert result.shape == (2, 4) # justificativa is dropped since only mapped cols are selected
